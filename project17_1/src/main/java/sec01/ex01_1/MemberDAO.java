	...
	public MemberVO findMember(String id) {
		...
		try {
			...
			ResultSet rs =pstmt.executeQuery();
				...
				Date joinDate2 = rs.getDate("joinDate");

				memInfo = new MemberVO();
				memInfo.setId(id2);
				memInfo.setPwd(pwd2);
				memInfo.setName(name2);
				memInfo.setEmail(email2);
				memInfo.setJoinDate(joinDate2);

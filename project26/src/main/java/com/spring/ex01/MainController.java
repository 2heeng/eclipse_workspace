...
//	public ModelAndView main7(Student stu, HttpServletRequest request, HttpServletResponse response) throws Exception {
//		
//		ModelAndView mav =new ModelAndView();
//		
//		stu.setBan(5);
...
//	}
	...
	public ModelAndView main7(@ModelAttribute("info") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response) throws Exception {
